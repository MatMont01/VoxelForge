        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-5 py-2 rounded-full bg-gradient-to-r from-[#ea9216]/15 to-[#ea9216]/30 border border-[#ea9216]/30 mb-6 backdrop-blur-sm shadow-inner">
            ...
            <span className="text-sm font-semibold text-[#ea9216] tracking-wide">
              import { Calendar, Heart, Award, Target, Box, Hammer, Sparkles, Layers, Infinity, Zap } from "lucide-react";
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                      ...
                      <div className="text-center mb-20">
                        ...
                        >
                          ...
                          <span className="text-[#ea9216] font-semibold">precisión digital</span>{" "}
                          con{" "}
                          <span className="text-[#ea9216] font-semibold">artesanía manual</span>.
                        </motion.p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto mb-16">
                        ...
                        >
                          ...
                          <div className="flex items-center mb-8 relative z-10">
                            ...
                            <h3 className="text-4xl font-bold text-gray-900 dark:text-white">VOXEL</h3>
                          </div>
                          <div className="space-y-6 relative z-10">
                            <div className="flex items-start">
                              <Layers className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-4 mt-1 flex-shrink-0" />
                              <div>
                                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Pixel 3D</h4>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                  Un <strong className="text-blue-500 dark:text-blue-400">voxel</strong> es la unidad mínima de un objeto tridimensional, como un pixel pero en 3D. Representa el
                                  <strong className="text-gray-800 dark:text-white"> fundamento digital</strong> de toda creación.
                                </p>
                              </div>
                            </div>
                            <div className="flex items-start">
                              ...
                              <div>
                                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Infinitas Posibilidades</h4>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                  Cada voxel es una <strong className="text-purple-600 dark:text-purple-400">posibilidad infinita</strong>. Combinados, crean mundos, objetos y sueños tangibles.
                                </p>
                              </div>
                            </div>
                        ...
                        >
                          ...
                          <div className="flex items-center mb-8 relative z-10">
                            ...
                            <h3 className="text-4xl font-bold text-gray-900 dark:text-white">FORGE</h3>
                          </div>
                          <div className="space-y-6 relative z-10">
                            <div className="flex items-start">
                              <Zap className="w-6 h-6 text-[#ea9216] mr-4 mt-1 flex-shrink-0" />
                              <div>
                                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Forja Creativa</h4>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                  <strong className="text-[#ea9216]">Forjar</strong> significa crear con maestría, transformando materias primas en obras funcionales con fuego y pasión.
                                </p>
                              </div>
                            </div>
                            <div className="flex items-start">
                              ...
                              <div>
                                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Transformación</h4>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                  Tomamos tus <strong className="text-yellow-600 dark:text-yellow-400">ideas digitales</strong> y las forjamos en realidad física, layer por layer.
                                </p>
                              </div>
                            </div>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8">
                          <div className="rounded-xl px-5 py-4 bg-gray-50 dark:bg-[#2a303a] border border-gray-200/60 dark:border-gray-700/60">
                            <span className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wide">Misión</span>
                            <p className="text-sm text-gray-800 dark:text-gray-200 leading-relaxed">{COMPANY_HISTORY.mission}</p>
                          </div>
                          <div className="rounded-xl px-5 py-4 bg-gray-50 dark:bg-[#2a303a] border border-gray-200/60 dark:border-gray-700/60">
                            <span className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wide">Visión</span>
                            <p className="text-sm text-gray-800 dark:text-gray-200 leading-relaxed">{COMPANY_HISTORY.vision}</p>
                          </div>
                        </div>
                        <div className="rounded-xl bg-gradient-to-r from-[#ea9216]/10 to-[#ea9216]/25 border border-[#ea9216]/30 p-5 shadow-inner">
                          <h4 className="font-bold text-gray-900 dark:text-white mb-2 flex items-center">
                            <Sparkles className="w-4 h-4 text-[#ea9216] mr-2" /> Del Hobby al Taller Profesional
                          </h4>
                          <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                            De una sola impresora a un flujo optimizado con equipos avanzados y procesos pulidos para clientes y proyectos personales que enriquecen nuestra experiencia.
                          </p>
                        </div>
                      </motion.div>
                      ...
                      >
                        <div className="text-center mb-12">
                          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-[#ea9216]/10 to-[#ea9216]/20 border border-[#ea9216]/25 mb-6">
                            ...
                            <span className="text-sm font-medium text-[#ea9216]">Nuestros Pilares</span>
                          </div>
                          <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-gray-900 via-[#ea9216] to-gray-900 dark:from-white dark:via-[#ea9216] dark:to-white bg-clip-text text-transparent mb-4">Valores</h3>
                          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">Principios que sostienen cada diseño, calibración y entrega.</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                          {values.map((val, i) => {
                            ...
                            return (
                              ...
                              >
                                <div className={`absolute inset-0 opacity-0 group-hover:opacity-10 bg-gradient-to-br ${val.accent} transition-opacity duration-700`} />
                                <div className={`w-20 h-20 mx-auto mb-6 rounded-2xl flex items-center justify-center bg-gradient-to-r ${val.accent} shadow-2xl ${val.glow} group-hover:scale-105 transition-transform`}>
                                  <Icon className="w-10 h-10 text-white" />
                                </div>
                                <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 group-hover:text-[#ea9216] transition-colors">{val.title}</h4>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{val.description}</p>
                      ...
                      <div className="text-center mt-16">
                        <div className="inline-flex items-center px-5 py-2 rounded-full bg-gradient-to-r from-[#ea9216]/10 to-[#ea9216]/25 border border-[#ea9216]/30 shadow-sm">
                          <Sparkles className="w-4 h-4 text-[#ea9216] mr-2" />
                          <span className="text-sm font-medium text-[#ea9216] tracking-wide">Calidad • Precisión • Pasión</span>
                        </div>
                      </div>
                    </div>
                  </section>
